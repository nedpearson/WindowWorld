...
export const FIELD_GUIDES: Record<string, FieldGuide> = {
  ...
  elevation: {
    field: 'elevation', label: 'Elevation (Side)', required: true,
    example: 'front',
    why: 'Tells installer which side of house. Must match sketch marker location.',
    commonMistakes: 'Using "left/right" without clarifying whose left/right (facing house vs. inside).',
    affects: ['installation'],
  },
  sillRepair: {
