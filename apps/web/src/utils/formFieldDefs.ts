...
export const ORDER_FORM_OPENING: FormFieldDef[] = [
  ...
  { id: 'oo-grid', label: 'Grid Style', form: 'order_form', section: 'Openings', source: 'opening', severity: 'HIGH', required: true, perOpening: true, dataPath: 'gridStyle' },
  { id: 'oo-gridpat', label: 'Grid Pattern', form: 'order_form', section: 'Openings', source: 'opening', severity: 'MEDIUM', required: false, perOpening: true, dataPath: 'gridPattern', condition: 'hasGrid' },
...
export const CONTRACT_FIELDS: FormFieldDef[] = [
  ...
  { id: 'ct-tax', label: 'Sales Tax', form: 'contract', section: 'Pricing', source: 'pricing', severity: 'BLOCKER', required: true, dataPath: 'taxAmount' },
...
export const SPECIALTY_SHAPES = ['eyebrow', 'circle_top', 'quarter_arch', 'custom_shape'];
