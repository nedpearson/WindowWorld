...
export const SPECIALTY_DIMENSION_SETS: SpecialtyDimensionSet[] = [
  {
    ...
    icon: '🪟',
    requiredDimensions: [
      { key: 'topSashWidth', label: 'Top Sash Width', unit: 'fraction_inches', hint: 'Measure THE TOP SASH only' },
      { key: 'topSashHeight', label: 'Top Sash Height', unit: 'fraction_inches', hint: 'Measure THE TOP SASH only' },
    ],
    optionalDimensions: [
